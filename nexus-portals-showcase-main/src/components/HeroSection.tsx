...
const HeroSection = () => {
  ...
  const typedRef = useRef<HTMLSpanElement>(null); // 👈 for typed.js
  ...
  useEffect(() => {
    ...
    if (typedRef.current) {
      const typed = new Typed(typedRef.current, {
        strings: ["Web Developer", "Java Developer","Software Developer", "Database Engineer", "Backend Developer","Full Stack Developer","AI Engineer","Competitive Programmer"],
        typeSpeed: 70,
        backSpeed: 70,
        backDelay: 1200,
        loop: true,
